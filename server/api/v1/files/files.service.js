  ...
  async listFiles(
    ...
    return new Promise(async (resolve, reject) => {
      try {
        ...
        connection.query('SELECT e.id, e.IPC, e.OEM ,e.Model ,e.Size ,e.LISS ,e.PATTERN ,e.AXLE ,e.MARKINGS ,e.TECHNOLOGIES, e.SHARE, pid.uuid FROM egypt e INNER JOIN product_uuid pid on e.PATTERN = pid.PATTERN ', function (err, result, fields) {
